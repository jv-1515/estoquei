...
import com.example.stokmais.dto.FiltroRelatorioDTO;
import com.example.stokmais.model.Produto;
import com.example.stokmais.repository.MovimentacaoProdutoRepository;
import com.example.stokmais.repository.MovimentacaoProdutoRepositoryCustomImpl;
    ...
    public byte[] gerarPDFProdutos(FiltroRelatorioDTO filtro) {
        ...
        if (filtro.getGraficoBase64() != null && !filtro.getGraficoBase64().isEmpty()) {
            ...
            for (Produto p : produtos) {
                ...
                List<com.example.stokmais.model.MovimentacaoProduto> historico =
                ...
                for (com.example.stokmais.model.MovimentacaoProduto m : historico) {
